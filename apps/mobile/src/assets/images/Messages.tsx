...
const SvgComponent = ({
  ...
  <Svg {...props} viewBox="0 0 32 32" fill="none">
    ...
    />
    <Defs>
      <LinearGradient id="a" x1={16} x2={16} y1={0.19} y2={31.809} gradientUnits="userSpaceOnUse">
        <Stop stopColor={colorStopOne} />
        <Stop offset={1} stopColor={colorStopTwo} />
      </LinearGradient>
      <LinearGradient id="b" x1={16} x2={16} y1={0.19} y2={31.809} gradientUnits="userSpaceOnUse">
        <Stop stopColor={colorStopOne} />
        <Stop offset={1} stopColor={colorStopTwo} />
      </LinearGradient>
    </Defs>
