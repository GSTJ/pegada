...
const OtpDigit = forwardRef<
  TextInput,
  Omit<React.ComponentPropsWithoutRef<typeof S.Container>, "children"> & OtpDigitProps
>(({ children, index, length, pointerEvents, handleChange, handleErase, testID }, ref) => {
  ...
  return (
    ...
    >
      <S.TextInput
        ...
        onKeyPress={({ nativeEvent: { key } }: { nativeEvent: { key: KeyboardKeys } }) => {
