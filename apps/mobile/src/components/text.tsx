 ...
 * modules build on it — `styled(Text)` on the styled-components side,
 * `withUnistyles(Text)` on the converted one — and both need something they
 * can render. The three theme-key props are Unistyles variants, so a theme
 * switch re-resolves them without the call sites knowing anything changed.
 */
export const Text = ({
  color,
  fontSize,
